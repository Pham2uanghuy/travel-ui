...
import { getAllPartnerPayments, approvePartnerPayment } from '../../services/partnerPayment';
...
const ManagerPaymentsPage: React.FC = () => {
    ...
    const handleApprove = async (id: number) => {
        ...
        try {
            await approvePartnerPayment(id, employeeId);
    ...
    return (
        <div className="p-6">
            <h1 className="text-2xl font-bold mb-4">Quản lý thanh toán - Quản lý</h1>
